...
CREATE TABLE IF NOT EXISTS documents (
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
  java_attach_id bigint NULL UNIQUE,
  java_doc_id varchar(128) NULL,
  publish_dept_id varchar(128) NULL,
  owner_user_id varchar(128) NULL,
  visible_in_chat boolean NOT NULL DEFAULT true,
  publish_scope varchar(32) NOT NULL DEFAULT 'dept',
  allowed_dept_ids text[] NULL,
